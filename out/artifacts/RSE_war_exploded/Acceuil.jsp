...
<div class="row" style="margin: 25px">
    <div class="col-3">
        ...
        <div class="card" style="max-width: 20rem;">
            ...
            <!-- Card image -->
             <div class="card-header" style="background-color: #74b9ff">
                <img src="static/img/icons8_Businessman_60px_1.png" >
              </div>
    ...
    <div class="col-6">
        <!-- espace de publication  -->
         <div id="esp_pub"><c:import url="espace_pub.jsp"/></div>
        <!-- /espace de publication  -->
        <br>

        <!--les publication -->
        <input type="hidden" value="${l_pub}" id="lastpub">
        <div id="esp_pub1">
                            ...
                            <div class="col-1">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" >
                                        <a class="dropdown-item" onclick="masque_pub('pub'+${publication.id_pub})">Masquer publication</a>
    ...
    <div class="col-3">
        ...
        <div class="card mb-3" style="max-width: 20rem;">
            <div class="card-body">
                ...
                <p class="card-text">On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, </p>
                <hr>
                <a class="card-link">familleslim1998@gmail.com</a>
            </div>
        </div>
    </div>
</div>
